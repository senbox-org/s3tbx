...
//                    1015.7390081732657};
    ...
    public double[] getRhoRayleigh(RayleighAux rayleighAux, double[] rayleighOpticalThickness, double[] corrOzoneRefl) {
        //for debugging.
        final double[] airMasses = rayleighAux.getAirMass();
        final double[] aziDiffs = rayleighAux.getAziDifferent();
        final double[] cosSZARads = rayleighAux.getCosSZARads();
    ...
    public double[] getRayleighThickness(RayleighAux rayleighAux,
        ...
        //test
        //getRayleighThicknessBodhaineTest();
    ...
    public void getRayleighThicknessBodhaineTest() {
        ...
        for (int i = 0; i < altitudes.length; i++) {
            ...
            for(int j=0; j<sigma.length; j++) {
                rayleighOpticalThickness[j] = getRayleighOpticalThickness(sigma[j], seaLevels[i], altitudes[i], latitudes[i]);
                if( altitudes[i]==0.){
    ...
    public double getRayleighOpticalThickness(double sigma, double seaLevelPressure, double altitude, double latitude) {
        ...
        //for getRayleighThicknessBodhaineTest() use only the following line (pressure is already at altitude):
        //double P = seaLevelPressure * 1000.;
