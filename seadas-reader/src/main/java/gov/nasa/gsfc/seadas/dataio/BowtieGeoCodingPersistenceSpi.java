...
public class BowtieGeoCodingPersistenceSpi implements PersistenceSpi {

    public static final BowtieGeoCodingPersistenceConverter CONVERTER = new BowtieGeoCodingPersistenceConverter();
    ...
    public boolean canEncode(Object object) {
        return object instanceof BowtieTiePointGeoCoding
               || object instanceof BowtiePixelGeoCoding;
    }
