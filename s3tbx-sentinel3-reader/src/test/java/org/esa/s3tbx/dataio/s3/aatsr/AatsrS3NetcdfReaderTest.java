...
public class AatsrS3NetcdfReaderTest {
    ...
    public void addVariableAsBand_DataType_CHAR() throws Exception {
        ...
        byte[] flagValues = {1, 2, 4};
        when(variable.findAttribute("flag_values")).thenReturn(attr("flag_values", Array.factory(DataType.BYTE, new int[]{flagValues.length}, flagValues)));
