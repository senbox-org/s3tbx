...
public enum Sensor {
    MERIS_3RD("MERIS_3RD", MERIS_NUM_SPECTRAL_BANDS, MERIS_RAD_BAND_NAMES_3RD,
              MERIS_REQUIRED_BRR_BAND_NAMES, MERIS_VALID_PIXEL_EXPR_3RD),
    MERIS_4TH("MERIS_4TH", MERIS_NUM_SPECTRAL_BANDS, MERIS_RAD_BAND_NAMES_4TH,
              MERIS_REQUIRED_BRR_BAND_NAMES, MERIS_VALID_PIXEL_EXPR_4TH),
    OLCI("OLCI", OLCI_NUM_SPECTRAL_BANDS, OLCI_RAD_BAND_NAMES,
         OLCI_REQUIRED_BRR_BAND_NAMES, OLCI_VALID_PIXEL_EXPR);
    ...
    Sensor(String name, int numSpectralBands, String[] radBandNames, String[] requiredBrrBandNames,
