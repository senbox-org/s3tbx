            ...
            steps {
                script {
                    def built = build(job: "snap-ci-nightly/master", parameters: [
                        [$class: 'StringParameterValue', name: 'tag', value: "9.x"],
                        [$class: 'StringParameterValue', name: 'docker', value: "snap-ci:9.x"],
                        [$class: 'StringParameterValue', name: 'engine', value: "9.x"],
                        [$class: 'BooleanParameterValue', name: 'engine_enabled', value: false],
                        [$class: 'StringParameterValue', name: 'desktop', value: "9.x"],
                        [$class: 'BooleanParameterValue', name: 'desktop_enabled', value: false],
                        [$class: 'StringParameterValue', name: 's1tbx', value: "9.x"],
                        [$class: 'BooleanParameterValue', name: 's1tbx_enabled', value: false],
                        [$class: 'StringParameterValue', name: 's2tbx', value: "9.x"],
                        [$class: 'BooleanParameterValue', name: 's2tbx_enabled', value: false],
                        [$class: 'StringParameterValue', name: 's3tbx', value: "9.x"],
                        [$class: 'BooleanParameterValue', name: 's3tbx_enabled', value: true],
                        [$class: 'StringParameterValue', name: 'smos', value: "5.9.x"],
                        [$class: 'BooleanParameterValue', name: 'smos_enabled', value: false],
                        [$class: 'StringParameterValue', name: 'probav', value: "2.3.x"],
                        [$class: 'BooleanParameterValue', name: 'probav_enabled', value: false],
                        [$class: 'StringParameterValue', name: 'installer', value: "9.x"],
