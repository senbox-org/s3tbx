...
public class C2rccOlciAlgorithm {
    ...
    C2rccOlciAlgorithm(final String[] nnFilePaths, final boolean loadFromResources) throws IOException {
...
//        double sin_sun = sin(toRadians(sun_zeni));
        ...
        */
            ...
            // cloud flag test @865
            flags = BitSetter.setFlag(flags, FLAG_INDEX_CLOUD, trans_nn[13] < thresh_cloudTransD);
...
//        Files.
        ...
        if (loadFromResource) {
            ...
            stream = C2rccOlciAlgorithm.class.getResourceAsStream(name);
            if (stream == null) {
