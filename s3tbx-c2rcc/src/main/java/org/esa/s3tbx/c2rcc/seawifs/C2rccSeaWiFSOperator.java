 ...
 */
@OperatorMetadata(alias = "c2rcc.seawifs", version = "1.0",
...
public class C2rccSeaWiFSOperator extends PixelOperator implements C2rccConfigurable {
    ...
    */
    ...
    @Parameter(description = "Path to the atmospheric auxiliary data directory. Use either this or ozoneStartProduct, " +
            "ozoneEndProduct, pressureStartProduct and pressureEndProduct to use ozone and air pressure aux data " +
