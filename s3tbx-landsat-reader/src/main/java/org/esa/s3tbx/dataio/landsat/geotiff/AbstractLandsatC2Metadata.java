 ...
 * @author Thomas Storm
 */
abstract class AbstractLandsatC2Metadata implements LandsatC2Metadata {
    ...
    protected String getProductType(String productTypeKey) {
        final MetadataAttribute product_type = getProductContents().getAttribute("PROCESSING_LEVEL");
