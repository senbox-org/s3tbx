...
public class C2rccMerisAlgorithmTest {
    ...
    public void testIt() throws Exception {
        ...
        double[] rwExpected1 = new double[result1.rwa.length];
        System.arraycopy(y1, 11, rwExpected1, 0, rwExpected1.length);
        assertArrayEquals(rwExpected1, result1.rwa, 1e-4);

        double[] iopsExpected1 = new double[result1.iops_nn.length];
        ...
        double[] rwExpected32 = new double[result32.rwa.length];
        System.arraycopy(y32, 11, rwExpected32, 0, rwExpected32.length);
        assertArrayEquals(rwExpected32, result32.rwa, 1e-4);

        double[] iopsExpected32 = new double[result32.iops_nn.length];
        ...
        for (int i = 0; i < iopsExpected32.length; i++) {
            ...
            double actual = result32.iops_nn[i];
